...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val pokemonList = mutableListOf(
            Pokemon(1,"Bulbasaur", 45, 49, 49, 45, Pokemon.PokemonType.GRASS,"https://onceuponapicture.files.wordpress.com/2017/03/joshua-dunlop-bulbasaur-watermarked.jpg", R.raw.bulbasaur),
            Pokemon(2, "Charmander", 39,52,43,65, Pokemon.PokemonType.FIRE,"https://static.wikia.nocookie.net/pokemon-and-digimon/images/6/63/Ash_Charmander.png/revision/latest?cb=20160113223827", R.raw.charmander),
            Pokemon(3,"Squirtle", 44,48,65,43,Pokemon.PokemonType.WATER,"https://static.wikia.nocookie.net/leonhartimvu/images/8/8c/Tierno_Squirtle.png/revision/latest?cb=20190128082527", R.raw.squirtle),
            ...
            //Pokemon(125,"Electabuzz",80,70,65,100,Pokemon.PokemonType.ELECTRIC,"https://lh3.googleusercontent.com/proxy/Ymic0LY3si4LcNIrvEhshfK4YGt-KIxCtKl2cNUp1dSWEByoVKCSvc9zv4mcwVWY1NWaDFu2FessJJD6Y8ckBNvrKTSD8b8zQP9ZB8Ifuxj4VGFPPtjwNRIXa40a1m5avN1c"),
